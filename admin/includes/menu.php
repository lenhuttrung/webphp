      ...
      <ul class="sidebar-menu" data-widget="tree">        
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="index.php?p=hoadon"><i class="fa fa-circle-o"></i> Hóa đơn</a></li>
            <li><a href="index.php?p=sanpham"><i class="fa fa-circle-o"></i> Sản Phẩm</a></li>
            <li><a href="index.php?p=loaisanpham"><i class="fa fa-circle-o"></i> Loại Sản Phẩm</a></li>
            <li><a href="index.php?p=khachhang"><i class="fa fa-circle-o"></i> Khách Hàng</a></li>
            <li><a href="index.php?p=lienhe"><i class="fa fa-circle-o"></i> Liên hệ</a></li>
            <li><a href="index.php?p=news"><i class="fa fa-circle-o"></i> Tin Tức</a></li>
            <li><a href="index.php?p=user"><i class="fa fa-circle-o"></i> User</a></li>
            <li><a href="index.php?p=slide"><i class="fa fa-circle-o"></i> Slide</a></li>
