...
<head>
    ...
    <meta http-equiv="refresh" 
        content="0;URL=/aitiphoto.com/admin/includes/login/login.php">
</head>
<body>
...
<!-- Mirrored from fox-admin-templates.multipurposethemes.com/foxadmin-minimal/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Dec 2018 02:04:15 GMT -->
<head>
    <meta charset="utf-8">
  ...
  <script>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $("input[name='tienship']").change(function(){
            var thanhtien = document.getElementById('tongtien').innerText;
            var tienship = document.getElementById('tienship').value;
            var tong = 0 ;
            tong = tong + Number(thanhtien) + Number(tienship);
...
<!-- Mirrored from fox-admin-templates.multipurposethemes.com/foxadmin-minimal/ by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 02 Dec 2018 02:05:55 GMT -->
</html>
<?php
  }
?>